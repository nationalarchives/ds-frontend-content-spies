...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="left" valign="top"> 
    ...
    <td width="615"><a class="breadcrumb" href="../default.htm">Home</a> 
      ...
      <span class="breadcrumb"> > Decrypt a Message</span></td>
  </tr>
</table>
<!-- breadcrumb end -->
<!-- body start -->
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
    <td width="625"><span class="bodyblack">You have been sent this encrypted message.</span></td>
</tr>
  <tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
  ...
  <tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="5" alt="*"></td>
    <td width="625"><span class="bodyblack">The decrypted message reads as "<%= Server.HTMLEncode(strMessageText) %>"</span></td>
</tr>
  <tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
    <td width="625"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
  ...
  <tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
    <td width="625"><img src="<%= strMessageHelpURL %>.gif" alt="<%= Server.HTMLEncode(strMessageText) %>"></td>
</tr>
<tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
    <td width="625"><img src="../images/pixeltrans.gif" width="25" height="10" alt="*"></td>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr align="left" valign="top"> 
    <td width="25"><img src="../images/pixeltrans.gif" width="25" height="25" alt="*"></td>
    <td width="330"><img src="../images/pixeltrans.gif" width="330" height="25" alt="*"></td>
    <td width="30"><img src="../images/pixeltrans.gif" width="30" height="25" alt="*"></td>
    <td width="255"><img src="../images/pixeltrans.gif" width="255" height="25" alt="*"></td>
  </tr>
